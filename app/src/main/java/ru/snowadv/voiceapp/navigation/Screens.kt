...
import presentation.feature.HomeFeatureScreens
...
object Screens {
    ...
    fun People() = FragmentScreen { ru.snowadv.people_impl.presentation.feature.PeopleFeatureScreens.People() }
    fun Profile(userId: Long?) = FragmentScreen { ProfileFeatureScreens.Profile(userId) }
    fun Home() = FragmentScreen { presentation.feature.HomeFeatureScreens.Home() }
}