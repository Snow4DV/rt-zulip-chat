...
internal object ProfileFragmentScreen : KScreen<ProfileFragmentScreen>() {
    ...
    val userName = KTextView { withId(ru.snowadv.profile_presentation.R.id.user_name) }
    val userEmail = KTextView { withId(ru.snowadv.profile_presentation.R.id.user_email) }
    val userAvatar = KImageView { withId(ru.snowadv.profile_presentation.R.id.user_avatar) }
    val userStatus = KTextView { withId(ru.snowadv.profile_presentation.R.id.user_status) }
