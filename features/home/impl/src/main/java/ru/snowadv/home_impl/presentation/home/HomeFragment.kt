...
import ru.snowadv.home_impl.presentation.home.elm.HomeStoreFactoryElm
import ru.snowadv.home_impl.databinding.FragmentHomeBinding
import ru.snowadv.home_impl.di.HomeFeatureComponent
...
internal class HomeFragment : BaseFragment<HomeEventElm, HomeEffectElm, HomeStateElm>(),
    ...
    override fun onAttach(context: Context) {
        ...
        HomeFeatureComponentHolder.getComponent().inject(this)
    }
    ...
    fun selectTab(screen: ru.snowadv.home_api.presentation.local_navigation.InnerHomeScreen) {
