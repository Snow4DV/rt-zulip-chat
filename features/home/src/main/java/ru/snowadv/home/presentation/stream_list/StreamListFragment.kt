...
import ru.snowadv.home.presentation.stream_list.view_model.StreamListViewModelFactory
...
class StreamListFragment : Fragment(), ErrorHandlingFragment by SnackbarErrorHandlingFragment(),
    ...
    private val chanelListSharedViewModel: ChannelListSharedViewModel by viewModels(
    ...
    private val viewModel: StreamListViewModel by viewModels {
        StreamListViewModelFactory(
            ...
            listSharedViewModel = chanelListSharedViewModel,
        )
    }
