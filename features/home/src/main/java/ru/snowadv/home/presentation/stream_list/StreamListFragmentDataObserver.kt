package ru.snowadv.home.presentation.stream_list
...
import ru.snowadv.home.databinding.FragmentStreamListBinding
import ru.snowadv.home.presentation.adapter.StreamAdapterDelegate
import ru.snowadv.home.presentation.adapter.TopicAdapterDelegate
import ru.snowadv.home.presentation.stream_list.event.StreamListFragmentEvent
import ru.snowadv.home.presentation.stream_list.state.StreamListScreenState
    ...
    private fun setupTopicAdapterDelegate(viewModel: StreamListViewModel): TopicAdapterDelegate {
        return TopicAdapterDelegate(
            onTopicClickListener = {
                viewModel.handleEvent(StreamListEvent.ClickedOnTopic(it.streamId, it.name))
            }
        )
    }
