...
import ru.snowadv.chat.databinding.ItemMessageOutgoingBinding
...
internal class OutgoingMessageLayout @JvmOverloads constructor(
    ...
    private val binding: ItemMessageOutgoingBinding =
        ItemMessageOutgoingBinding.inflate(layoutInflater, this)
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val heightPx =
            messageTextView.measuredHeight + timestampTextView.measuredHeight + reactionsContainer.measuredHeight + paddingBetweenMessageBoxAndReactionsPx.toInt() + paddingTop + paddingBottom
    ...
    override fun getInsertIndexForNewReaction(): Int {
        return binding.reactionsContainer.childCount - 1
    }
        ...
        context.obtainStyledAttributes(
            ...
            .use { styledAttributes ->
                paddingBetweenReactionsPx = styledAttributes.getDimensionPixelSize(
                    R.styleable.OutgoingMessageLayout_paddingBetweenReactionsInOutgoingMessage,
                    dimToPx(
                ...
                paddingBetweenMessageBoxAndReactionsPx = styledAttributes.getDimensionPixelSize(
                    R.styleable.OutgoingMessageLayout_paddingBetweenMessageBoxAndReactionsInOutgoingMessage,
                    dimToPx(
                ...
                messageText =
                    styledAttributes.getString(R.styleable.OutgoingMessageLayout_messageTextInOutgoingMessage)
                        ?: DEFAULT_MESSAGE_TEXT
                timestampText =
                    styledAttributes.getString(R.styleable.OutgoingMessageLayout_timestampTextInOutgoingMessage)
