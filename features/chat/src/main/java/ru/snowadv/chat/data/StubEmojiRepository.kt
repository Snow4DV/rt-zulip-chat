...
internal class StubEmojiRepository : EmojiRepository {
    override fun getAvailableEmojis(): Collection<Emoji> {
        return emojiMap.values
    }

    override fun getEmojiByCode(code: Int): Emoji? {
        return emojiMap[code]
    }

    override fun getEmojiByStringCode(code: String): Emoji? {
        return emojiMap[Integer.decode(code)]
    }

    private val emojiMap = listOf(
